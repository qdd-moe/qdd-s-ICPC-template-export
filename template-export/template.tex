...
\usepackage{hyperref}
\hypersetup{hidelinks,colorlinks=false,breaklinks=true,hyperfootnotes=true,unicode}
...
\date{\usdate\today}
\titleformat{\chapter}[hang]{\Large\bfseries}{Part~\thechapter}{1em}{}
\titlespacing*{\chapter}{0pt}{0pt}{10pt}

\setmainfont[BoldFont={Noto Serif SemiBold}]{Noto Serif}
\setsansfont[BoldFont={Noto Sans SemiBold}]{Noto Sans}
\setmonofont[Scale=0.9]{Source Code Pro}  % scale is needed for visual balance between Chinese and English
...
\renewcommand{\chaptername}{Part~\thechapter}
